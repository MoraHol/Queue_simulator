class PrinterConsole
  ...
  def print_prom
    puts "el tiempo promedio de espera de los clientes fue de: #{@simulator.calculation_time_wait_clients} minutos"
    puts "se atendieron #{@simulator.market.clients_attended.size} clientes"
  end
